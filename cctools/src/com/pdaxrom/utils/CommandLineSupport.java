 ...
 */
 final public class CommandLineSupport {
	 ...
	 */
	static public String quote(final String arg) {
	 ...
	 */
	static public String quote(final List<String> args) {
	 ...
	 */
	static public List<String> split(final String commandline) {
